...
%
% USAGE:
%   [cGM,cWM,cCSF,rcGM,rcWM,rcCSF] = bmp_misc_spmSegmentation (inputImg,spm12path)
%   [cGM,cWM,cCSF,rcGM,rcWM,rcCSF,seg8mat] = bmp_misc_spmSegmentation (inputImg,spm12path)
%

function [cGM,cWM,cCSF,rcGM,rcWM,rcCSF,varargout] = bmp_misc_spmSegmentation (inputImg, spm12path)
