...
%
% USAGE:
%   flowMap = bmp_misc_spmRunDARTELe (rcGM, rcWM, rcCSF, ...
%                              template1, template2, template3, template4, template5, template6)



function flowMap = bmp_misc_spmRunDARTELe (rcGM, rcWM, rcCSF, template1, template2, template3, template4, template5, template6)
