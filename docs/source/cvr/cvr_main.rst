...
Existing resources for data analysis
------------------------------------
...
.. toctree::
   ...
   CVR analysis using quantiphyse <cvr_quantiphyse>
   CVR analysis using phys2cvr <cvr_phys2cvr>
   CVR analysis using MRIcloud <cvr_mricloud>
   Other miscellaneous things regarding CVR <cvr_others>
