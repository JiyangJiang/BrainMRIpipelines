...
.. toctree::
   ...
   DCE-MRI data acquired in VasMarker study - explained <dce_data>
   Generating B1 map using Siemens product TFL sequence with hMRI toolbox <dce_b1map_hmri>
   Generating T1 map after correcting nominal flip angles of MP2RAGE using B1 map with qMRLab <dce_t1map_qmrlab>
