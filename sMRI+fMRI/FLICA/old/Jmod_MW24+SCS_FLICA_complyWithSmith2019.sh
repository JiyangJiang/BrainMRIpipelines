...
#                     VBM
# +++++++++++++++++++++++++++++++++++++++++++++
# 1. FSL-VBM with SPM skull-stripping
#    Note : erosion twice to remove the dura regions.
fslmaths c1${subID}_anat \
		 -add c2${subID}_anat \
         -add c3${subID}_anat \
         -thr 0.3 \
         -bin \
         ...
         -ero \
         -ero \
         ${subID}_anat_brainmask

fslmaths ${subID}_anat \
         -mas ${subID}_anat_brainmask \
         ${subID}_anat_brain
...
flirt -in SCS+MW24_VBM_N354 \
	  -ref SCS+MW24_VBM_N354 \
	  -applyisoxfm 4 \
	  -init eye.mat \
	  -out SCS+MW24_VBM_N354_4mm
