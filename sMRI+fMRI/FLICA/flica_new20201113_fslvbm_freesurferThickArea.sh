...
# copy generated files on NiL cluster back to GRID to generate html reports
# -------------------------------------------------------------------------
exit
cd ${outdir}
rsync -avrPS jiyang@129.94.18.57:~/Downloads/* .
...
# in MATLAB
cd /data4/jiyang/MW24+SCS_FLICA/flica/flica_new20201113_fslvbm_freesurferThickArea/
...
save ('flica_new20201113_fslvbm_freesurferThickArea','-v7.3');