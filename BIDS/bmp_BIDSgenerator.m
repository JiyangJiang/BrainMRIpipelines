...
% +++++++++++++++++++++++++++
%
% dataset = 'ADNI'           (use preset configuration for ADNI dataset).
%
%           'clinica-ADNI'   (currently same as 'ADNI')
%
%           'other'          (for any dataset other than ones described above).
%
...
% ------------------------------------------------------------------------
	...
	elseif strcmp (dataset, 'clinica-ADNI')

		addParameter (p, 'Modalities',	{'asl'},	@iscell);
