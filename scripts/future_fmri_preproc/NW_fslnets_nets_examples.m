...
addpath /data_pub/Software/FSL/fsl-5.0.11/FSLNets/FSLNets                         % wherever you've put this package
addpath /data_pub/Software/FSL/fsl-5.0.11/FSLNets/L1precision/L1precision         % L1precision toolbox
addpath /data_pub/Software/FSL/fsl-5.0.11/FSLNets/pairwise_causal                 % pairwise causality toolbox
...
%%% ================================================================================
% spatial maps 4D NIFTI file, e.g. from group-ICA
group_maps = '/home/jiyang/Work/fMRI/test/dataset3/groupICA/d20/melodic_IC';
...
% This can be done with the script NW_fslnets_preparation.sh.

% dual regression output directory, containing all subjects' timeseries
ts_dir = '/home/jiyang/Work/fMRI/test/dataset3/groupICA/grp_mean_dualReg_rand_results';
...
% arg3 controls variance normalisation: 
%      0 = none
...
%%% ============================================
%%% cleanup and remove bad nodes' timeseries
%%% (whichever is not listed in ts.DD is *BAD*).
%%% ============================================
% list the good nodes in your group-ICA output (counting starts at 1, not 0)
% J: This will need to be done manually?
ts.DD=[1 2 3 4 5 6 7 9 11 14 15 17 18];

% optionally setup a list of unknown components (where you're unsure of good vs bad)
% ts.UNK=[10];

% regress the bad nodes out of the good, and then remove the bad nodes' timeseries 
% (1=aggressive, 0=unaggressive (just delete bad)).
%
...
% have a look at mean spectra after this cleanup
ts_spectra=nets_spectra(ts);


%%% ============================================
%%% create various kinds of network matrices and
%%% optionally convert correlations to z-stats.
%%% ============================================
...
%%% returns t-test Z values as a network matrix
%%% ===============================================
% 1) second argument (0 or 1) determines whether to display 
%    the Z matrix and a consistency scatter plot.
%
% 2) third argument (optional) groups runs together; 
%    e.g. setting this to 4 means each group of 4 runs were
...
%%% =====================================
% arg1 is shown below the diagonal (and drives the clustering/hierarchy);
% arg2 is shown above diagonal
...
%%% ====================================================================
%%% cross-subject GLM,
%%% with inference in randomise
%%% (assuming you already have the GLM design.mat and design.con files).
%%% ====================================================================
% arg4 determines whether to view the corrected-p-values,
% with non-significant entries removed above the diagonal.
...
%%% ========================================================
%%% simple cross-subject multivariate discriminant analyses,
%%% for just two-group cases.
%%% ========================================================
