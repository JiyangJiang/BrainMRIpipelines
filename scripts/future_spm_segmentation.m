...
%
% USAGE:
%   [cGM,cWM,cCSF,rcGM,rcWM,rcCSF] = future_spm_segmentation (inputImg,spm12path)
%   [cGM,cWM,cCSF,rcGM,rcWM,rcCSF,seg8mat] = future_spm_segmentation (inputImg,spm12path)
%

function [cGM,cWM,cCSF,rcGM,rcWM,rcCSF,varargout] = future_spm_segmentation (inputImg, spm12path)
