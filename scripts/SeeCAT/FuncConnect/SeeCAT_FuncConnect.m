...
% Last Modified by GUIDE v2.5 20-Jun-2016 16:25:53
...
fprintf('Calculating Functional Connectivity Starts.\n');
...
cd(WorkDir);
fprintf('Calculating Functional Connectivity Finishes.\n');
toc
