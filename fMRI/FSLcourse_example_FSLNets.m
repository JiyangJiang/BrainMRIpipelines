...
addpath  /Applications/fsl/FSLNets
...
addpath /Applications/fsl/FSLNets/LIBSVM/matlab
...
dualReg_folder = '/Users/z3402744/Work/datasets/FSLcourse_exampleData_rest/Nets/groupICA100.dr';
% TR
tr = 0.72;
% slice summary folder (without .sum suffix)
slc_sum = '/Users/z3402744/Work/datasets/FSLcourse_exampleData_rest/Nets/groupICA100';
% path to the folder containing the design matrix and contrasts
desmtx_con_path = '/Users/z3402744/Work/datasets/FSLcourse_exampleData_rest/Nets/design';
% design matrix and contrast base name for group comparison
desmtx_con_basename = 'unpaired_ttest_1con';
...
% spectra overlapping.
% ============================================================
% - left plot : group averaged frequency spectra of individual
%               nodes (i.e. IC). grey line = average across 
%               all nodes. Therefore, the grey line is identical
%               for each component.
% - left plot : raised tail = noise node.
% - right plot : all normalised to peak 1 and overlaid.
...
% - Similar to the cleanup in MELODIC, you need to decide this
...
% ============================================================
%         Compute a network matrix for each subject
% ============================================================
...
% -----------------------------------------------------------------------
% J : For some reason, the script is not permutating for 5000 times.
