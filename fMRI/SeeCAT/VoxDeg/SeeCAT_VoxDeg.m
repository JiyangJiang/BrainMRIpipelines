...
% Last Modified by GUIDE v2.5 21-Jun-2016 10:02:04
...
set(handles.Mask_edit,'String',[ProgramPath,filesep,'templates',filesep,'GMwithoutCER_61x73x61.nii']);
...
fprintf('Calculating Voxel-based Degree Starts.\n');
...
parfor i = 1:length(Sublist)
    fprintf(['Calculating Voxel-based Degree:',Sublist(i).name,' Starts.\n']);
    vol_VoxDeg = cell(1);
...
cd(WorkDir);
fprintf('Calculating Voxel-based Degree Finishes.\n');
toc
