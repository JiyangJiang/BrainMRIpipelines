%------------------
% bmp_fmri_ini_Xbrain_SPMsegment
%------------------
%
% DESCRIPTION:
...
%
% USAGE:
%   [cGM,cWM,cCSF,rcGM,rcWM,rcCSF] = bmp_fmri_ini_Xbrain_SPMsegment (inputImg,spm12path)
%   [cGM,cWM,cCSF,rcGM,rcWM,rcCSF,seg8mat] = bmp_fmri_ini_Xbrain_SPMsegment (inputImg,spm12path)
%

function [cGM,cWM,cCSF,rcGM,rcWM,rcCSF,varargout] = bmp_fmri_ini_Xbrain_SPMsegment (inputImg, spm12path)
